  ...
  return (
    <button
      ...
      onClick={(e) => {
        ...
        const imageSource = btnRef.current.querySelector(
          ".hidden",
        )! as HTMLImageElement;
        ...
        imageEl.src = imageSource.src;
        imageEl.alt = imageSource.alt;
    ...
    >
      ...
      <div className="flex flex-row w-full">
        {Array.from({ length: katakanaMax }).map((_, idx) => (
          <div
            key={idx}
            className="h-10 border-[0.1px] w-full flex dark:text-white items-center justify-center font-zenka font-semibold text-xl"
          >
